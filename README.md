...
## Railway Deployment (Parallel With AWS)

This project is now prepared for Railway with `railway.toml`.
...
The app supports both environment styles:
...
git branch -M main
git remote add origin https://github.com/MilosGak97/moverlead-railway.git
